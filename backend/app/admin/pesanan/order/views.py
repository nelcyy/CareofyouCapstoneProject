...
def _detail_order_payload(order):
    ...
    return {
        ...
        'ereceipt_customer_name': receipt.customer_name if receipt else '',
        'ereceipt_customer_email': receipt.customer_email if receipt else '',
        'ereceipt_total': receipt.total if receipt else 0,
        'ereceipt_signature_hash': receipt.signature_hash if receipt else '',
        'ereceipt_is_revoked': receipt.is_revoked if receipt else False,
